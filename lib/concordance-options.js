...
exports.withColors = {plugins, theme: colorTheme};
exports.plain = {plugins, theme: plainTheme};
exports.recommended = {plugins, theme: options.color === false ? plainTheme : colorTheme};
